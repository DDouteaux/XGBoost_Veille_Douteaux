...
\pagestyle{fancy}
\lhead{\textsc{\textbf{\thColor{Veille technologique}}} \& XGBoost, origines et application, \textit{Damien Douteaux}}
\rhead{\includegraphics[height=.5cm]{images/Logo/logo}}
\cfoot{\thepage\ / \pageref{LastPage}}
  
\newcommand{\mysidenote}[1]{\sidenote{\scriptsize{#1}}}
\newcommand{\mysidenoteoffset}[2]{\sidenote[][#1]{\scriptsize{#2}}}
\renewcommand*{\thesidenote}{\thColor{\arabic{sidenote}}}
