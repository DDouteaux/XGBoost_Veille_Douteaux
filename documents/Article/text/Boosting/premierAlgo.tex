...
\begin{figure}[h]
	...
	\sidecaption[fig:boosting_situation]{Deux ensembles à séparer par le modèle que l'on entraîne (d'après~\cite{bib:elghazel})}
...
\begin{figure}[h]
	...
	\end{subfigure}\hfill
	\sidecaption{Premier modèle appris sur les données (d'après~\cite{bib:elghazel})}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}\hfill
	\sidecaption{Deuxième modèle appris sur les données (d'après~\cite{bib:elghazel})}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}\hfill
	\sidecaption{Troisième modèle appris sur les données (d'après~\cite{bib:elghazel})}
\end{figure}
...
\begin{figure}[h]
	\sidecaption{Prévision finale conjointe des trois classifieurs entraînés par Boosting (d'après~\cite{bib:elghazel})}
