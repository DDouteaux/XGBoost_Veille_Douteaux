...
\fill [gray!20] (9,1) circle (4pt);
\fill [gray!20] (6,3.25) circle (4pt);
\fill [gray!20] (7,3.25) circle (4pt);
\draw (8,3.1) circle (4pt);
\draw (8.8,3.1) circle (4pt);
\draw (9.8,3) circle (4pt);
\fill [black] (11,3) circle (4pt);
\fill [gray!20] (2.8,4.75) circle (4pt);
...
\fill [gray!20] (4.5,7.6) \Square{4pt};
...
\fill [gray!20] (3.2,8.7) \Square{4pt};
\draw (8.9,8.1) circle (4pt);
\fill [draw] (10.1,8.25) circle (4pt);
\fill [gray!20] (1.9,9.6) \Square{4pt};
\fill [gray!20] (5.4,9.8) \Square{4pt};
\fill [gray!20] (8.2,9.6) \Square{4pt};
\fill [gray!20] (3,10.9) \Square{4pt};
\fill [gray!20] (4.9,10.8) \Square{4pt};
\fill [gray!20] (6.9,10.6) \Square{4pt};
\fill [gray!20] (9.2,10.6) \Square{4pt};
\draw (11.2,10.6) circle (4pt);
\fill [gray!20] (3,11.6) \Square{4pt};
\fill [gray!20] (4.8,11.8) \Square{4pt};
\fill [gray!20] (1.8,12.8) \Square{4pt};
\fill [gray!20] (4.8,12.8) \Square{4pt};
\fill [gray!20] (7.1,13.95) \Square{4pt};
\fill [gray!20] (8.2,13.8) \Square{4pt};
\fill [gray!20] (1.8,14.5) \Square{4pt};
\fill [gray!20] (7.1,14.6) \Square{4pt};
